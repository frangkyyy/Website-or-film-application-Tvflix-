...
/**
 * ambil semua genre misalnya: [{"id" : "123", "name": "Action"}]
 * lalu ​​ubah format genre misal: {123: "Action"}
 */
 const genreList = {

     // buat genre string dari genre_id: [23,43] -> "Action", "Romance"
...
<div class="slider-control">
    ...
    for (const [index, movie] of movieList.entries()){
        ...
        alt="Slide to ${title}" loading="lazy" draggable="false" class="img-cover">
        `;
